...
const SEED_SOURCES = [
  ...
  { onChainId: 7,  category: "Protocol",       title: "HTTP 402 and the Future of Machine Payments", url: "https://docs.cdp.coinbase.com/x402/docs/welcome", creatorName: "Coinbase Developer Platform", creatorHandle: "@coinbase_dev", payoutWallet: "0xa20C8F958a31A78Be4bcf33CecA8B463636050ce", price: 2500, bond: 10000, contentHash: "327d0c9a1e2e214d2658b334afac90483ea11836b6676ef8035854a52a08d8b4", description: "HTTP 402 Payment Required has been dormant since the 1990s. x402 revives it as a machine-native payment protocol, enabling any HTTP endpoint to require payment before serving content — perfect for AI agent workflows." },
  { onChainId: 8,  category: "Research",       title: "Content Integrity and Hash Verification in Web3", url: "https://ipfs.tech/blog/content-addressing", creatorName: "Protocol Labs", creatorHandle: "@protocollabs", payoutWallet: "0x578087F20dfF74e3dB0841C9514285648B4339DE", price: 2000, bond: 5000, contentHash: "77ed5dbce0e8699cf34d041e4db6af0b697821ea25094eca3ee328a4a3dde5d4", description: "Content-addressed storage ensures that what you paid for is what you received. By storing a SHA-256 hash of content at payment time, CitePay Markets can objectively verify if a creator modified their source after receiving payment." },
